...
- ✅ **AI 卡片流式回复**：支持钉钉 AI 卡片，实时流式输出回复内容（打字机效果）
...
插件支持使用钉钉 AI 卡片进行流式回复，AI 生成内容时会实时推送到卡片中，呈现打字机效果，提升对话体验。
...
开启后，机器人回复时会：
1. 立即展示 AI 卡片（显示"处理中"状态）
2. AI 生成过程中逐步输出内容（打字机效果）
3. 生成完毕后卡片自动完成

![流式回复效果](docs/images/dingtalk/dingtalk-streaming.jpg)
